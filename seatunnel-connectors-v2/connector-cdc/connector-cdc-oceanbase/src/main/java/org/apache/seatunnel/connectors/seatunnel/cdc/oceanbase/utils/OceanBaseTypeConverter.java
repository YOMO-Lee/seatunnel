...
public class OceanBaseTypeConverter implements TypeConverter<BasicTypeDefine<MysqlType>> {
    ...
    public static final OceanBaseTypeConverter DEFAULT_INSTANCE =
            new OceanBaseTypeConverter(MySqlVersion.V_5_7);

    private final MySqlVersion version;

    public OceanBaseTypeConverter(MySqlVersion version) {
        this.version = version;
    }

    public OceanBaseTypeConverter() {
        ...
        switch (mysqlDataType) {
            ...
            default:
                throw CommonError.convertToSeaTunnelTypeError(
                        OceanBaseOption.CONNECTOR_NAME, mysqlDataType, typeDefine.getName());
        }
        ...
        switch (column.getDataType().getSqlType()) {
            ...
            default:
                throw CommonError.convertToConnectorTypeError(
                        OceanBaseOption.CONNECTOR_NAME,
