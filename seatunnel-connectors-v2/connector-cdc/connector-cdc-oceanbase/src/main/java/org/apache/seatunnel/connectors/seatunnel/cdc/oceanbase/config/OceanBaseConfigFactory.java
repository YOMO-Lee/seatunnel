...
public class OceanBaseConfigFactory extends JdbcSourceConfigFactory {
     ...
     * explicit value."
     */
    public OceanBaseConfigFactory serverId(String serverId) {
        this.serverIdRange = ServerIdRange.from(serverId);
        return this;
    }

    /** Creates a new {@link OceanBaseConfig} for the given subtask {@code subtaskId}. */
    public OceanBaseConfig create(int subtaskId) {
